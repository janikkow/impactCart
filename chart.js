(function(global){
  ...
  Chart.prototype.drawBar = function(){
    ...
    var duration = (this.options.animation && this.options.animation.duration) || 1000;
    var start = null;
    var self = this;
    ...
    function draw(progress){
      ...
      for(var i=0;i<data.length;i++){
        ...
        ctx.fillText(String(Math.round(value)), padding + i * barWidth + barWidth/2, y - 5);
      }
    }
